...
rates.chf = 1.1787;
console.log(rates);
console.log(`With 100 Euroes, you will have ${rates.BGN*100} Australian Dollars`);
var highestrate = 0;
var maxSymbol = '';
for (var r in rates){
    if(rates[r]>highestrate){
        highestrate = rates[r];
        maxSymbol = r;
    }
}
console.log(`The property with the largest value is ${maxSymbol} at ${highestrate} ${maxSymbol} to 1 Euro`);
